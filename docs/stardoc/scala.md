...
| <a id="configure_bootstrap_scala-compiler_classpath"></a>compiler_classpath |  -   | <a href="https://bazel.build/concepts/labels">List of labels</a> | required |  |
...
| <a id="configure_bootstrap_scala-runtime_classpath"></a>runtime_classpath |  -   | <a href="https://bazel.build/concepts/labels">List of labels</a> | required |  |
...
| <a id="configure_bootstrap_scala-use_ijar"></a>use_ijar |  Whether to use ijars for this compiler.   | Boolean | optional |  `True`  |
| <a id="configure_bootstrap_scala-version"></a>version |  -   | String | required |  |
...
| <a id="scala_import-deps"></a>deps |  -   | <a href="https://bazel.build/concepts/labels">List of labels</a> | optional |  `[]`  |
| <a id="scala_import-exports"></a>exports |  -   | <a href="https://bazel.build/concepts/labels">List of labels</a> | optional |  `[]`  |
| <a id="scala_import-jars"></a>jars |  -   | <a href="https://bazel.build/concepts/labels">List of labels</a> | optional |  `[]`  |
| <a id="scala_import-neverlink"></a>neverlink |  -   | Boolean | optional |  `False`  |
| <a id="scala_import-runtime_deps"></a>runtime_deps |  -   | <a href="https://bazel.build/concepts/labels">List of labels</a> | optional |  `[]`  |
| <a id="scala_import-srcjar"></a>srcjar |  -   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
...
| <a id="scala_repl-deps"></a>deps |  -   | <a href="https://bazel.build/concepts/labels">List of labels</a> | optional |  `[]`  |
...
| <a id="scala_repl-scala"></a>scala |  The `ScalaConfiguration`.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `"@//external:default_scala"`  |
| <a id="scala_repl-scalacopts"></a>scalacopts |  The Scalac options.   | List of strings | optional |  `[]`  |
...
| <a id="scaladoc-deps"></a>deps |  -   | <a href="https://bazel.build/concepts/labels">List of labels</a> | optional |  `[]`  |
| <a id="scaladoc-srcs"></a>srcs |  -   | <a href="https://bazel.build/concepts/labels">List of labels</a> | optional |  `[]`  |
| <a id="scaladoc-compiler_deps"></a>compiler_deps |  -   | <a href="https://bazel.build/concepts/labels">List of labels</a> | optional |  `[]`  |
| <a id="scaladoc-scala"></a>scala |  -   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `"@@[unknown repo 'scala' requested from @@]//:scala"`  |
| <a id="scaladoc-scalacopts"></a>scalacopts |  -   | List of strings | optional |  `[]`  |
| <a id="scaladoc-title"></a>title |  -   | String | optional |  `""`  |
