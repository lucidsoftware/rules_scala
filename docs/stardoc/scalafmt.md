...
scala_format_test(<a href="#scala_format_test-name">name</a>, <a href="#scala_format_test-srcs">srcs</a>, <a href="#scala_format_test-scalafmt_toolchain_name">scalafmt_toolchain_name</a>)
</pre>
...
| <a id="scala_format_test-scalafmt_toolchain_name"></a>scalafmt_toolchain_name |  The name of the Scalafmt configuration toolchain.   | String | optional |  `""`  |
