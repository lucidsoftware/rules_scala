...
<a id="scalafmt_default_config"></a>
...
| :------------- | :------------- | :------------- |
| <a id="scalafmt_default_config-path"></a>path |  <p align="center"> - </p>   |  `".scalafmt.conf"` |


<a id="scalafmt_repositories"></a>
